...
OK  -   Verificar se o número da conta de origem, de destino, senha da conta de origem e valor da transferência foram informados no body
OK -   Verificar se a conta bancária de origem informada existe
OK -   Verificar se a conta bancária de destino informada existe
OK -   Verificar se a senha informada é uma senha válida para a conta de origem informada
OK  -   Verificar se há saldo disponível na conta de origem para a transferência
Ok   -   Subtrair o valor da transfência do saldo na conta de origem
OK  -   Somar o valor da transferência no saldo da conta de destino
...
OK  -   Verificar se o numero da conta e a senha foram informadas (passado como query params na url)
    -   Verificar se a conta bancária informada existe
...
-   Você deverá, **OBRIGATORIAMENTE**:
 ...
 OK   -   Verificar se o numero da conta e a senha foram informadas (passado como query params na url)
  OK  -   Verificar se a conta bancária informada existe
  OK  -   Verificar se a senha informada é uma senha válida
